...
export type TextInputProperties = {
	...
	TextColorGuide: (Enum.StudioStyleGuideColor | types.StateObject<Enum.StudioStyleGuideColor>),
	[any]: any,
}
...
return function(props: TextInputProperties): TextLabel
	...
	local newTextBox = BoxBorder {
		...
		[Children] = New "TextBox" {
			...
			TextColor3 = getMotionState(themeProvider:GetColor(props.TextColorGuide, mainModifier), "Spring", 40),--[[Computed(function()
				return getMotionState(themeProvider:GetColor(props.TextColorGuide, mainModifier), "Spring", 40):get()
			end),]]
